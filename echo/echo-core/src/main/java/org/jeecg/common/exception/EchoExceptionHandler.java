...
@Slf4j
public class EchoExceptionHandler {

	/**
	 * 处理自定义异常
	 */
	@ExceptionHandler(EchoException.class)
	public Result<?> handleJeecgBootException(EchoException e){
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(Echo401Exception.class)
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public Result<?> handleJeecgBoot401Exception(Echo401Exception e){
		log.error(e.getMessage(), e);
